...
//    {
//        SaveResouresToRL<string, string>(new ExistsDirectory(Directory.ExistsNull), AppData.ci);
//    }
...
//    {
//        SaveResouresToRL<string, string>(path, new ExistsDirectory(Directory.ExistsNull), AppData.ci);
//    }
...
//            File.WriteAllTextAsync(file, xlfContent, enc);
...
//            xlfContent = rm.GetByteArrayAsString(fn);
//            //xlfContent = xlfContent.Skip(3);
//            File.WriteAllTextAsync(file2, xlfContent, enc);
...
//                else
//                {
//                    throw new Exception(sess.i18n(XlfKeys.UnvalidFile) + " " + file + ", please delete it");
//                }
//            }
//        }
